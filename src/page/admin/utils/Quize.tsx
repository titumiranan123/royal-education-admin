...
const QuizForm = ({ isVisible, onClose }) => {
        ...
        <div className="z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white rounded-lg shadow-lg p-6 w-[800px] h-auto">
                <div className="flex justify-end">
                    <button className="text-gray-700 hover:text-gray-900 focus:outline-none" onClick={onClose} aria-label="Close">
                ...
                <div className="mb-4">
                    ...
                    >
                        ...
                        {options.map((option, index) => (
                            <option key={index} value={option}>{optionLabels[index]}: {option}</option>
                        ))}
                    </select>
                </div>
                <div className="flex justify-end">
                    <button
                        ...
                        type="button"
                        onClick={() => alert('Question Saved!')} // Replace with your save function
                    >
                        Save Question
                    </button>
                </div>
